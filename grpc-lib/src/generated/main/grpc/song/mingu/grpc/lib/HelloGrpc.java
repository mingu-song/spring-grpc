...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<song.mingu.grpc.lib.HelloRequest,
      song.mingu.grpc.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = song.mingu.grpc.lib.HelloRequest.class,
      responseType = song.mingu.grpc.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<song.mingu.grpc.lib.HelloRequest,
      song.mingu.grpc.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<song.mingu.grpc.lib.HelloRequest, song.mingu.grpc.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<song.mingu.grpc.lib.HelloRequest, song.mingu.grpc.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  song.mingu.grpc.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  song.mingu.grpc.lib.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(song.mingu.grpc.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<song.mingu.grpc.lib.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                song.mingu.grpc.lib.HelloRequest,
                song.mingu.grpc.lib.HelloReply>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloBlockingStub> {
     ...
     * </pre>
     */
    public song.mingu.grpc.lib.HelloReply sayHello(song.mingu.grpc.lib.HelloRequest request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractFutureStub<HelloFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<song.mingu.grpc.lib.HelloReply> sayHello(
        song.mingu.grpc.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((song.mingu.grpc.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<song.mingu.grpc.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return song.mingu.grpc.lib.HelloProto.getDescriptor();
    }
